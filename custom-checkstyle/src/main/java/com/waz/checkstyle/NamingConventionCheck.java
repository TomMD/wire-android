...
public class NamingConventionCheck extends Check {
  ...
  private static final String MSG_CONSTANT =
      "Constant '%s' should be named in all uppercase with underscores.";
  private static final String MSG_UNDERSCORE =
      "Underscores are not allowed in non-constant variable names. Use camelCase for '%s'.";
  ...
  private static final String MSG_UPPERCASE =
      "Variable name '%s' should begin with a lower-case letter.";
  ...
  public void visitToken(DetailAST ast) {
    ...
    if (isStaticVariable(modifiersAST) && isFinalVariable(modifiersAST)) {
      ...
      if (isStaticVariable(modifiersAST) && NamingConventionsDetector.detectsStaticPrefix(name)) {

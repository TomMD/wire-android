...
public class AccentColorController implements IAccentColorController {
  ...
  public AccentColorController(
      Context context, IUserPreferencesController userPreferencesController) {
  ...
  private void notifyAccentColorHasChanged(
      AccentColorChangeRequester accentColorChangeRequester, int color) {

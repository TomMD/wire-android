...
public class GlobalLayoutController implements IGlobalLayoutController {
  ...
  private KeyboardVisibilityListener.Callback keyboardCallback =
      new KeyboardVisibilityListener.Callback() {
        @Override
  ...
  @Override
  public void removeKeyboardVisibilityObserver(
  ...
  protected void notifyKeyboardVisibilityHasChanged(boolean keyboardIsVisible, int keyboardHeight) {
    for (KeyboardVisibilityObserver keyboardVisibilityObserver : keyboardVisibilityObservers) {
      keyboardVisibilityObserver.onKeyboardVisibilityChanged(
          keyboardIsVisible, keyboardHeight, activity.getCurrentFocus());
    }
  }
  ...
  public void setSoftInputModeForPage(Page page) {
    ...
    ViewUtils.setSoftInputMode(activity.getWindow(), getSoftInputModeForPage(page), TAG);
  }

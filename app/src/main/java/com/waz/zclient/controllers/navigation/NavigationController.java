...
public class NavigationController implements INavigationController {
  ...
  private static final String SAVED_INSTANCE_CURRENT_PAGER_POSITION =
      "SAVED_INSTANCE_CURRENT_PAGER_POSITION";
  ...
  private static final String SAVED_INSTANCE_CURRENT_RIGHT_PAGE =
      "SAVED_INSTANCE_CURRENT_RIGHT_PAGE";
  private static final String SAVED_INSTANCE_PAGER_ENABLE_STATE =
      "SAVED_INSTANCE_PAGER_ENABLE_STATE";
  ...
  @Override
  public void addNavigationControllerObserver(
  ...
  @Override
  public void removeNavigationControllerObserver(
      NavigationControllerObserver navigationControllerObserver) {
  ...
  public void setVisiblePage(Page page, String sender) {
    ...
    for (NavigationControllerObserver navigationControllerObserver :
        navigationControllerObservers) {

...
public class UserPreferencesController implements IUserPreferencesController {
  ...
  // TODO Move these preferences to the UserPreferences service in SE, since a lot of them are
  // user-scoped anyway.
  ...
  public static final String USER_PREFS_GENERIC_INVITATION_TOKEN =
      "USER_PREFS_GENERIC_INVITATION_TOKEN";
  public static final String USER_PREFS_PERSONAL_INVITATION_TOKEN =
      "USER_PREFS_PERSONAL_INVITATION_TOKEN";
  private static final String USER_PREFS_SHOW_SHARE_CONTACTS_DIALOG =
      "USER_PREFS_SHOW_SHARE_CONTACTS_DIALOG ";
  ...
  private static final String USER_PREF_UNSUPPORTED_EMOJIS_CHECKED =
      "USER_PREF_UNSUPPORTED_EMOJIS_CHECKED";
  ...
  public String getDeviceId() {
    ...
    if (id == null) {
      ...
      userPreferences.edit().putString(PREFS_DEVICE_ID, id).apply();
    }
    return id;
  }
  ...
  public void addRecentEmoji(String emoji) {
    RecentEmojis recentEmojis =
        new RecentEmojis(userPreferences.getString(USER_PREF_RECENT_EMOJIS, null));
  ...
  public List<String> getRecentEmojis() {
    return new RecentEmojis(userPreferences.getString(USER_PREF_RECENT_EMOJIS, null))
        .getRecentEmojis();
  }

...
public class OrientationController implements IOrientationController {
  ...
  @Override
  public void addOrientationControllerObserver(
      OrientationControllerObserver orientationControllerObserver) {
    orientationControllerObservers.add(orientationControllerObserver);
  }

  @Override
  public void removeOrientationControllerObserver(
      OrientationControllerObserver orientationControllerObserver) {
  ...
  private void notifyOrientationHasChanged(SquareOrientation squareOrientation) {
    for (OrientationControllerObserver orientationControllerObserver :
        orientationControllerObservers) {

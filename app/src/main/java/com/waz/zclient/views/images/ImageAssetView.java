...
public class ImageAssetView extends ImageView implements UpdateListener {
  ...
  private final BitmapCallback loadCallback =
      new BitmapCallback() {
        ...
        public void onBitmapLoaded(Bitmap bitmap) {
          Timber.i(
              "ImageAssetView %s :: onBitmapLoaded(), id=%s, w=%d, h=%d",
              ImageAssetView.this, imageAsset.getId(), bitmap.getWidth(), bitmap.getHeight());
  ...
  private void logBitmapLoadError() {
    Timber.e(
        "ImageAssetView %s :: failed loading bitmap for %s id=%s",
        this, imageAsset, imageAsset != null ? imageAsset.getId() : null);
  }

...
public class InfiniteLoadingBarView extends View {
  ...
  private static final Property<InfiniteLoadingBarView, Float> TIME =
      new Property<InfiniteLoadingBarView, Float>(Float.class, "time") {
        @Override
  ...
  protected void onDraw(Canvas canvas) {
    ...
    canvas.drawLine(
        ...
        loadingBarPaint);
    canvas.drawLine(
        time * (canvas.getWidth() + strokeGap),
        strokeWidth / 2,
        canvas.getWidth(),
        strokeWidth / 2,
        loadingBarPaint);

...
public class ConfirmationMenu extends LinearLayout {
          ...
          switch (v.getId()) {
            case R.id.positive:
              ...
              boolean checkboxIsSelected =
                  checkBoxView.getVisibility() == VISIBLE && checkBoxView.isSelected();
              animateToShow(false);
  ...
  private void initAttributes(AttributeSet attrs) {
    ...
    checkboxSelectedByDefault =
        a.getBoolean(R.styleable.ConfirmationMenu_checkboxIsSelected, false);
  ...
  public void animateToShow(boolean show) {
    if (show) {
      ...
      messageContainerView.post(
          new Runnable() {
            @Override
            public void run() {

              ObjectAnimator showBackgroundAnimator =
                  ObjectAnimator.ofFloat(backgroundView, View.ALPHA, 0, 1);
              showBackgroundAnimator.setInterpolator(new Quart.EaseOut());
              showBackgroundAnimator.setDuration(
                  getResources().getInteger(R.integer.framework_animation_duration_short));

              ObjectAnimator showMessageAnimator =
              ...
              showMessageAnimator.setDuration(
                  getResources().getInteger(R.integer.framework_animation_duration_medium));
              showMessageAnimator.setStartDelay(
                  getResources()
                      .getInteger(
                          R.integer.framework_animation__confirmation_menu__show_message_delay));
              showMessageAnimator.addListener(
      ...
      ObjectAnimator hideBackgroundAnimator =
          ObjectAnimator.ofFloat(backgroundView, View.ALPHA, 1, 0);
      hideBackgroundAnimator.setInterpolator(new Quart.EaseOut());
      hideBackgroundAnimator.setDuration(
          getResources().getInteger(R.integer.framework_animation_duration_short));
      hideBackgroundAnimator.setStartDelay(
          getResources()
              .getInteger(R.integer.framework_animation__confirmation_menu__hide_background_delay));
      hideBackgroundAnimator.addListener(
          new AnimatorListenerAdapter() {
            @Override
      ...
      ObjectAnimator hideMessageAnimator =
          ObjectAnimator.ofFloat(
              messageContainerView,
              View.TRANSLATION_Y,
              0,
      ...
      hideMessageAnimator.setDuration(
          getResources().getInteger(R.integer.framework_animation_duration_medium));

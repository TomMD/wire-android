...
public class ImageAssetImageView extends FrameLayout implements UpdateListener {
  ...
  /** The handle to bitmap loading processes. A started request can be canceled via the handle. */
   ...
   */
  public ImageAssetImageView(Context context, AttributeSet attrs, int defStyleRes) {
  ...
  private void init() {
    ...
    blurRadius =
        ViewUtils.toPx(getContext(), getResources().getInteger(R.integer.background__blur_radius));
  ...
  /**
   * Changes the display type and if the change is relevant and an image asset exists it updates the
   * bitmap.
   *
   * @param displayType
   */
  ...
  public void connectImageAsset(
      ImageAsset imageAsset, TransitionType transitionType, boolean forceBlur) {
  ...
  /**
   * Creates a drawable form a raw bitmap and sets it as as the source of this image view.
   *
  ...
  private void setBitmapWithTransition(Bitmap bitmap) {
    ...
    switch (transitionType) {
      case SCALE:
        ...
        imageViewOut.animate().alpha(0).setDuration(crossfadeDuration);
        break;
      case FADE:
        imageViewIn.animate().alpha(1).setDuration(crossfadeDuration);
        imageViewOut.animate().alpha(0).setDuration(crossfadeDuration);
        break;
      case FADE_EXPO_IN_OUT:
        imageViewIn
            ...
            .setDuration(550)
            .setDuration(550);
        imageViewOut.animate().alpha(0).setInterpolator(new Expo.EaseInOut()).setDuration(550);
        break;
    }
  }
  ...
  public void resetBackground() {
    ...
    if (swapImageView1 == null || swapImageView2 == null) {
      return;
    }
    swapImageView1
        .animate()

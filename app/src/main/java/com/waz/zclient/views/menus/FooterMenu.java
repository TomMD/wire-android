...
public class FooterMenu extends FrameLayout {
  ...
  private void setCustomAttributes(Context context, AttributeSet attrs) {
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FooterMenu);
  ...
  public void setCallback(final FooterMenuCallback callback) {
    if (callback == null) {
      ...
      leftActionContainerView.setOnClickListener(
          new OnClickListener() {
            @Override
      ...
      rightActionContainerView.setOnClickListener(
          new OnClickListener() {
            @Override
            public void onClick(View view) {

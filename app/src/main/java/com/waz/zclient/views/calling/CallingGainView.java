...
public class CallingGainView extends View implements PositionAnimatable {
   ...
   *
   * @param volume Should be a value between 0.0f - 1.0f. However, currently AVS is providing linear
   *     values, so we currently apply a logarithmic function to the incoming values to get the true
   *     gain.
   */

...
public class CountryCodeAdapter extends BaseAdapter {
  ...
  public View getView(int i, View convertView, ViewGroup viewGroup) {
    ...
    if (convertView == null) {
      View view =
          LayoutInflater.from(viewGroup.getContext())
              .inflate(R.layout.row__country, viewGroup, false);
      viewHolder = new CountryViewHolder();
      viewHolder.nameTextView =
          ViewUtils.getView(view, R.id.ttv_new_reg__signup__phone__country__row);
      viewHolder.countryCodeTextView =
          ViewUtils.getView(view, R.id.ttv_new_reg__signup__phone__country__row_code);
      convertView = view;
    ...
    if (!TextUtils.isEmpty(getItem(i).getCountryCode())) {
      viewHolder.countryCodeTextView.setText(
          String.format("+%s", getItem(i).getCountryCode().trim()));
    }

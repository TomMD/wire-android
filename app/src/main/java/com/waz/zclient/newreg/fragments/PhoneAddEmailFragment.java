...
public class PhoneAddEmailFragment extends BaseFragment<PhoneAddEmailFragment.Container>
  ...
  public void onStart() {
    ...
    getControllerFactory()
        .getGlobalLayoutController()
        .setSoftInputModeForPage(Page.PHONE_REGISTRATION_ADD_NAME);

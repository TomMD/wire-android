...
public class EphemeralLayout extends LinearLayout {
  ...
  protected void onFinishInflate() {
    ...
    ContextThemeWrapper cw =
        new ContextThemeWrapper(getContext(), com.waz.zclient.ui.R.style.NumberPickerText);
    ...
    numberPicker.setOnClickListener(
        new OnClickListener() {
          ...
          public void onClick(View v) {
            if (callback != null) {
              callback.onEphemeralExpirationSelected(
                  ephemeralExpirationsValues[numberPicker.getValue()], true);
            }
          }
        });
    numberPicker.setOnValueChangedListener(
        new NumberPicker.OnValueChangeListener() {
          ...
          public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
            if (callback != null) {
              callback.onEphemeralExpirationSelected(
                  ephemeralExpirationsValues[numberPicker.getValue()], false);
            }
          }
        });
    try {
      Field f =
          numberPicker.getClass().getDeclaredField("mSelectionDivider"); // NoSuchFieldException
      f.setAccessible(true);
      f.set(
          numberPicker,
          getResources().getDrawable(com.waz.zclient.ui.R.drawable.number_picker_divider));
    } catch (Throwable t) {
  ...
  private String getDisplayName(EphemeralExpiration expiration) {
    switch (expiration) {
      case NONE:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__off);
      case FIVE_SECONDS:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__5_sec);
      case FIFTEEN_SECONDS:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__15_sec);
      case THIRTY_SECONDS:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__30_sec);
      case ONE_MINUTE:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__1_min);
      case FIVE_MINUTES:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__5_min);
      case ONE_DAY:
        return getContext()
            .getString(com.waz.zclient.core.R.string.ephemeral_message__timeout__1_day);
      default:

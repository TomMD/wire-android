...
public class VoiceFilterRecordingLayout extends FrameLayout
    implements VoiceFilterController.RecordingObserver, Subscriber<float[]> {
  ...
  public void onRecordingStarted(RecordingControls recording, Instant timestamp) {
    ...
    waveGraphView.animate().alpha(1f);

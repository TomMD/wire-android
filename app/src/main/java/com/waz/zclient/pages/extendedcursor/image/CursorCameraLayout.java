...
public class CursorCameraLayout extends FrameLayout
    implements View.OnClickListener, CameraPreviewObserver {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    setMeasuredDimension(
        MeasureSpec.makeMeasureSpec(width / 2, MeasureSpec.EXACTLY), heightMeasureSpec);

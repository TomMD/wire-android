...
public class DrawingFragment extends BaseFragment<DrawingFragment.Container>
  ...
  private View.OnTouchListener drawingCanvasViewOnTouchListener =
  ...
  private Toolbar.OnMenuItemClickListener toolbarOnMenuItemClickListener =
  ...
  private View.OnTouchListener sketchEditTextOnTouchListener =
      new View.OnTouchListener() {
  ...
  private SketchEditText.SketchEditTextListener sketchEditTextListener =
      new SketchEditText.SketchEditTextListener() {
        @Override
        public void editTextChanged() {
          sketchEditTextView.setBackground(
              ColorUtils.getRoundedTextBoxBackground(
                  getContext(), currentBackgroundColor, sketchEditTextView.getMeasuredHeight()));
        }
      };

  public static DrawingFragment newInstance(
      ImageAsset backgroundAsset, IDrawingController.DrawingDestination drawingDestination) {
    return DrawingFragment.newInstance(
        backgroundAsset, drawingDestination, IDrawingController.DrawingMethod.DRAW);
  }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    drawingDestination =
        DrawingController.DrawingDestination.valueOf(args.getString(ARGUMENT_DRAWING_DESTINATION));
    drawingMethod =
        DrawingController.DrawingMethod.valueOf(args.getString(ARGUMENT_DRAWING_METHOD));
  ...
  public View onCreateView(
    ...
    colorLayout.setAccentColors(
        colors, getControllerFactory().getAccentColorController().getColor());
    ...
    final TypefaceTextView conversationTitle =
        ViewUtils.getView(rootView, R.id.tv__drawing_toolbar__title);
    ...
    actionButtonText.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            onTextClick();
    ...
    actionButtonEmoji.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            onEmojiClick();
    ...
    actionButtonSketch.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            onSketchClick();
  ...
  public void setBackgroundBitmap(boolean showHint) {
    ...
    drawingViewTip.setTextColor(
        ContextUtils.getColorWithTheme(R.color.drawing__tip__font__color_image, getContext()));

    cancelLoadHandle();
    bitmapLoadHandle =
        backgroundImage.getSingleBitmap(
            ContextUtils.getOrientationDependentDisplayWidth(getActivity()),
            new BitmapCallback() {
              @Override
  ...
  private View.OnClickListener sketchButtonsOnClickListener =
      new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          if (drawingCanvasView == null) {
  ...
  public void onColorSelected(int color, int strokeSize) {
    ...
    sketchEditTextView.setBackground(
        ColorUtils.getRoundedTextBoxBackground(
            getContext(), color, sketchEditTextView.getHeight()));
  ...
  public void onScaleChanged(float scale) {
    ...
    FrameLayout.LayoutParams params =
        (FrameLayout.LayoutParams) sketchEditTextView.getLayoutParams();
    clampSketchEditBoxPosition(params);
    sketchEditTextView.setLayoutParams(params);
  }
  ...
  public void onKeyboardVisibilityChanged(
      boolean keyboardIsVisible, int keyboardHeight, View currentFocus) {
  ...
  private void changeEditTextVisibility(int keyboardHeight) {
    if (shouldOpenEditText) {
      ...
      FrameLayout.LayoutParams params =
          (FrameLayout.LayoutParams) sketchEditTextView.getLayoutParams();
      params.leftMargin =
          (((ViewGroup) sketchEditTextView.getParent()).getMeasuredWidth()
                  - sketchEditTextView.getMeasuredWidth())
              / 2;
      params.topMargin =
          ((ViewGroup) sketchEditTextView.getParent()).getMeasuredHeight()
              - keyboardHeight
  ...
  private void drawSketchEditText() {
    if (sketchEditTextView.getVisibility() == View.VISIBLE) {
      ...
      // This has to be on a post otherwise the setAlpha and setCursor won't be noticeable in the
      // drawing cache
      getView()
          .post(
              new Runnable() {

...
public class ImagePreviewLayout extends FrameLayout
    implements ConfirmationMenuListener, View.OnClickListener {
  ...
  protected void onFinishInflate() {
    ...
    approveImageSelectionMenu.setCancel(
        getResources().getString(R.string.confirmation_menu__cancel));
    approveImageSelectionMenu.setConfirm(
        getResources().getString(R.string.confirmation_menu__confirm_done));
  ...
  public void setImageAsset(final ImageAsset imageAsset, Source source, Callback callback) {
    this.source = source;
  ...
  public void onClick(View view) {
    switch (view.getId()) {
      ...
      case R.id.gtv__preview__drawing_button__sketch:
        if (callback != null) {
          callback.onSketchOnPreviewPicture(
              imageAsset, source, IDrawingController.DrawingMethod.DRAW);
        }
        break;
      case R.id.gtv__preview__drawing_button__emoji:
        if (callback != null) {
          callback.onSketchOnPreviewPicture(
              imageAsset, source, IDrawingController.DrawingMethod.EMOJI);
        }
        break;
      case R.id.gtv__preview__drawing_button__text:
        if (callback != null) {
          callback.onSketchOnPreviewPicture(
              imageAsset, source, IDrawingController.DrawingMethod.TEXT);
        }
        break;
    }
  }
  ...
  public void setTitle(String title) {
    ...
    titleTextViewContainer.setVisibility(
        TextUtils.isEmpty(titleTextView.getText()) ? GONE : VISIBLE);
  }

  public void hightlightTitle() {
    TextViewUtils.highlightAndBoldText(
        titleTextView,
        ContextCompat.getColor(getContext(), R.color.sharing__image_preview__title__color));
  }
  ...
  public interface Callback {
    ...
    void onSketchOnPreviewPicture(
        ImageAsset imageAsset, Source source, IDrawingController.DrawingMethod method);

...
public class VoiceFilterContent extends ViewAnimator {
  ...
  private void addRecordingLayout() {
    voiceFilterRecordingLayout =
        (VoiceFilterRecordingLayout)
            LayoutInflater.from(getContext())
                .inflate(R.layout.voice_filter_control_record, this, false);
    addView(voiceFilterRecordingLayout);
  }

  private void addGridView() {
    LayoutInflater inflater = LayoutInflater.from(getContext());
    voiceFilterGridLayout =
        (VoiceFilterGridLayout) inflater.inflate(R.layout.voice_filter_grid, this, false);

...
public class ExtendedCursorContainer extends FrameLayout
    implements KeyboardHeightObserver, KeyboardVisibilityObserver {
  ...
  private static final String PREF__KEY__KEYBOARD_HEIGHT_LANDSCAPE =
      "PREF__KEY__KEYBOARD_HEIGHT_LANDSCAPE";
  ...
  public void openEmojis(
      List<String> recent, Set<String> unsupported, EmojiKeyboardLayout.Callback callback) {
    ...
    switch (type) {
        ...
        voiceFilterLayout =
            (VoiceFilterLayout)
                LayoutInflater.from(getContext())
                    .inflate(R.layout.voice_filter_layout, this, false);
        voiceFilterLayout.setAccentColor(accentColor);
      ...
      case IMAGES:
        ...
        cursorImagesLayout =
            (CursorImagesLayout)
                LayoutInflater.from(getContext())
                    .inflate(R.layout.cursor_images_layout, this, false);
      ...
      case EMOJIS:
        ...
        emojiKeyboardLayout =
            (EmojiKeyboardLayout)
                LayoutInflater.from(getContext())
                    .inflate(R.layout.emoji_keyboard_layout, this, false);
      ...
      case EPHEMERAL:
        ...
        ephemeralLayout =
            (EphemeralLayout)
                LayoutInflater.from(getContext())
                    .inflate(R.layout.ephemeral_keyboard_layout, this, false);
  ...
  private void initKeyboardHeight() {
    defaultExtendedContainerHeight =

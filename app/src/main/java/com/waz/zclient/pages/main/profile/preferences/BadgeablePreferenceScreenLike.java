...
public class BadgeablePreferenceScreenLike extends Preference {
  ...
  public BadgeablePreferenceScreenLike(
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    TypedArray a =
        context.obtainStyledAttributes(
            attrs, R.styleable.BadgeablePreferenceScreenLike, defStyleAttr, defStyleRes);
  ...
  protected void onClick() {
    getPreferenceManager()
        ...
        .onNavigateToScreen(getPreferenceScreen());
  }
  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    if (getIcon() != null) {
      ...
      layoutParams.setMarginStart(
          getContext().getResources().getDimensionPixelSize(R.dimen.wire__padding__big)

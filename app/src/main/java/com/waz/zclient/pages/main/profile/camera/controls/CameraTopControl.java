...
public class CameraTopControl extends FrameLayout {
  ...
  private void init() {
    ...
    cameraDirectionButton.setOnClickListener(
  ...
  private void setFlashModeButton(FlashMode flashMode) {
    ...
    ObjectAnimator.ofFloat(cameraFlashButton, View.ALPHA, 0, 1)
        .setDuration(getResources().getInteger(R.integer.camera__control__ainmation__duration_long))
        .start();
  }

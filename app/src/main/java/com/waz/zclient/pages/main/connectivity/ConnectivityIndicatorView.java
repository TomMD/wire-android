...
public class ConnectivityIndicatorView extends FrameLayout {
  ...
  public ConnectivityIndicatorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    animationDuration =
        getContext().getResources().getInteger(R.integer.network_indicator__animation_duration);
    messageShowDuration =
        getContext()
            .getResources()
            .getInteger(R.integer.network_indicator__show_expanded__duration);
  ...
  private void init() {
    ...
    removedPosition =
        -getContext().getResources().getDimension(R.dimen.network_indicator__expanded_height);
    collapsedPosition =
        -getContext().getResources().getDimension(R.dimen.network_indicator__collapse_position);

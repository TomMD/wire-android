...
/**
 * If you know the size of the image, you can set the size of the view independently. In that case
 * we want to block the requestLayout call while setting the image to the view.
 *
 * <p>{@see <a href="https://plus.google.com/+JorimJaggi/posts/iTk4PjgeAWX">Blog post by Jorim
 * Jaggi</a>}
 */

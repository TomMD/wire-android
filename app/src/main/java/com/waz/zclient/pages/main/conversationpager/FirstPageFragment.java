...
public class FirstPageFragment extends BaseFragment<FirstPageFragment.Container>
  ...
  public void onStart() {
    ...
    if (openedFromBackStack
        || getChildFragmentManager().findFragmentById(R.id.fl__first_page_container) != null) {
      return;
    }
    ...
    getControllerFactory()
        ...
        .setLeftPage(com.waz.zclient.controllers.navigation.Page.CONVERSATION_LIST, TAG);
  }

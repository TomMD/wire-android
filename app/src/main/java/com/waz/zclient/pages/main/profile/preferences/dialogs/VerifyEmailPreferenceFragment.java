...
public class VerifyEmailPreferenceFragment
    extends BaseDialogFragment<VerifyEmailPreferenceFragment.Container> {
    ...
    resendButton.setOnClickListener(
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            getStoreFactory().profileStore().resendVerificationEmail(email);
          }
        });
    final String resendHtml =
        getString(R.string.pref__account_action__email_verification__resend, email);

...
public class VoiceFilterGridLayout extends FrameLayout
    implements VoiceFilterController.RecordingObserver, VoiceFilterController.PlaybackObserver {
    ...
    for (int r = 0; r < numRows; r++) {
      ...
      for (int c = 0; c < numCols; c++) {
        ...
        if (c < numCols - 1) {
          ...
          row.addView(
              view,
              new LayoutParams(
                  ViewUtils.toPx(getContext(), 0.5f), ViewGroup.LayoutParams.MATCH_PARENT));
        }
      }
      ...
      if (r < numRows - 1) {
        ...
        container.addView(
            view,
            new LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewUtils.toPx(getContext(), 0.5f)));
      }
    }
  }
  ...
  public View createItemView(final int r, final int c) {
    ...
    FrameLayout frameLayout =
        (FrameLayout) inflater.inflate(R.layout.voice_filter_grid_icon, this, false);

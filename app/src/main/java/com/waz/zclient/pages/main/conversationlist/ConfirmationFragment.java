...
public class ConfirmationFragment extends BaseFragment<ConfirmationFragment.Container>
    implements OnBackPressedListener, AccentColorObserver {
  ...
  public static ConfirmationFragment newMessageOnlyInstance(
      String title, String message, String confirm, String dialogId) {
  ...
  public View onCreateView(
    ...
    confirmationMenu.useModalBackground(
        getArguments().getBoolean(OPTIONAL_FIELD_USE_BLACK_BACKGROUND));

    confirmationMenu.setCallback(
  ...
  public interface Container {
    /**
     * @param dialogId The {@link ConfirmationFragment#OPTIONAL_FIELD_DIALOG_ID} argument passed to
     *     the Fragment. Can be useful for identifying the callback. Will be an empty string if no
     *     dialogId argument is passed to the Fragment.
     */

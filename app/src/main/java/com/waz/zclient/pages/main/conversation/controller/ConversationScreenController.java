...
public class ConversationScreenController implements IConversationScreenController {
  private Set<ConversationScreenControllerObserver> conversationScreenControllerObservers =
      new HashSet<>();
  ...
  @Override
  public void addConversationControllerObservers(
      ConversationScreenControllerObserver conversationScreenControllerObserver) {
    // Prevent concurrent modification (if this add was executed by one of current observers during
    // notify* callback)
    Set<ConversationScreenControllerObserver> observers =
        new HashSet<>(conversationScreenControllerObservers);
    observers.add(conversationScreenControllerObserver);
    conversationScreenControllerObservers = observers;
  }

  @Override
  public void removeConversationControllerObservers(
      ConversationScreenControllerObserver conversationScreenControllerObserver) {

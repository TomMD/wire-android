...
public class CameraBottomControl extends ViewAnimator {
  ...
  public void setCameraBottomControlCallback(
      CameraBottomControlCallback cameraBottomControlCallback) {
  ...
  private void addCameraControlsLayout(
      LayoutInflater inflater, boolean allowCloseButton, boolean showGalleryButton) {
    ...
    takeAPictureButton.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {

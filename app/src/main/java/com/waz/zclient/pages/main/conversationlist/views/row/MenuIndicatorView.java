...
public class MenuIndicatorView extends FrameLayout {
  ...
  private void init() {
    ...
    int totalWidth =
        getResources().getDimensionPixelSize(R.dimen.conversation_list__left_icon_width);
    int distanceDotsToContainerEdge =
        (totalWidth
                - 3
                    * getResources()
                        .getDimensionPixelSize(R.dimen.list__menu_indicator__dot__radius)
                - 2
                    * getResources()
    ...
    firstDotAnimationOffsetX =
        getResources()
            .getDimensionPixelSize(R.dimen.list__menu_indicator__dot__first_animation_offset_x);
    secondDotAnimationOffsetX =
        getResources()
            .getDimensionPixelSize(R.dimen.list__menu_indicator__dot__second_animation_offset_x);

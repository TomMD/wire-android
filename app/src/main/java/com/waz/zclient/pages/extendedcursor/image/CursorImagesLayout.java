...
public class CursorImagesLayout extends FrameLayout
    implements View.OnClickListener, CursorImagesAdapter.AdapterCallback {
  ...
  protected void onFinishInflate() {
    ...
    GridLayoutManager layout =
        new GridLayoutManager(getContext(), IMAGE_ROWS, GridLayoutManager.HORIZONTAL, false);
    layout.setSpanSizeLookup(
        new GridLayoutManager.SpanSizeLookup() {
          @Override
          public int getSpanSize(int position) {
            return (cursorImagesAdapter.getItemViewType(position)
                    == CursorImagesAdapter.VIEW_TYPE_CAMERA)
                ? IMAGE_ROWS
                : 1;
          }
        });
    ...
    int dividerSpacing =
        getContext()
            ...
            .getDimensionPixelSize(
                R.dimen.extended_container__camera__gallery_grid__divider__spacing);
  ...
  public void onCameraPreviewDetached() {
    ...
    buttonNavToCamera.animate().setInterpolator(new Quint.EaseOut()).alpha(1);
  }

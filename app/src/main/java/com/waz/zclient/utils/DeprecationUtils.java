...
public class DeprecationUtils {
  ...
  public static int WAKE_LOCK_OPTIONS =
  ...
  /**
   * We need to use an interface as Java doesn't have first class functions. We need
   * CameraParamsWrapper so we can instantiate this interface in Scala code without writing the type
   * "Params" as this gives a deprecation warning
   */

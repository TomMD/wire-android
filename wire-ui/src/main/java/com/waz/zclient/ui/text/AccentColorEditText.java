...
public class AccentColorEditText extends android.support.v7.widget.AppCompatEditText {
  ...
  /**
   * Whenever the hint textSize is smaller than the regular textSize for a given EditText, the
   * cursor shrinks to fit the text. This method can be overridden to set the cursor padding so that
   * it remains the full size of the EditText.
   */
  ...
  protected void updateCursor() {
    ...
    try {
      ...
      Field df =
          ReflectionUtils.getInheritedPrivateField(editorObject.getClass(), "mCursorDrawable");

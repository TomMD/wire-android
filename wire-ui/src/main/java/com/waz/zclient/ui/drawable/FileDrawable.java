...
public class FileDrawable extends Drawable {
  ...
  public FileDrawable(Context context, String extension) {
    ...
    glyphPaint.setTextSize(
        context.getResources().getDimensionPixelSize(R.dimen.content__audio_message__button__size));

    textPaint.setAntiAlias(true);
    textPaint.setTextAlign(Paint.Align.CENTER);
    textPaint.setTextSize(
        context.getResources().getDimensionPixelSize(R.dimen.wire__text_size__tiny));
  }

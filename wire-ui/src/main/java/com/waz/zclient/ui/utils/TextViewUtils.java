...
public class TextViewUtils {
  ...
  /**
   * Will highlight a single section of a TextView between 2 "_" marks. For example, in "Click
   * _HERE_ please." "HERE" will be made the color specified and bolded.
   *
   * @param textView
   * @param highlightColor
   *     <p>CAUTION: This does not work together with textAllCaps attribute!
   */
  ...
  public static CharSequence getHighlightText(
      Context context, String string, int highlightColor, boolean bold) {
    ...
    if (highlightStart >= highlightEnd) {
      Timber.e(
          "Failed to highlight text - make sure you have 2 _ markers to denote start and end of highlight region");
      return string;
    }
  ...
  /**
   * Will bold all sections of the text in a TextView which have [[ ]] around them. For example
   * "Here [[we]] are [[now]]." would bold "we" and "now".
   *
   * @param textView
   *     <p>CAUTION: This does not work together with textAllCaps attribute!
   */
  ...
  public static CharSequence getBoldHighlightText(
      Context context, String text, int highlightColor, int highlightStart, int highlightEnd) {
    return getTypefaceHighlightText(
        context, text, R.string.wire__typeface__bold, highlightColor, highlightStart, highlightEnd);
  }

  /**
   * Will make all sections of the text in a TextView which have [[ ]] around them medium font. For
   * example "Here [[we]] are [[now]]." would make "we" and "now" medium.
   *
   * @param textView
   *     <p>CAUTION: This does not work together with textAllCaps attribute!
   */
  ...
  /**
   * Will highlight all sections with the desired {@param typefaceRes} of the text in a TextView
   * which have [[ ]] around them. For example "Here [[we]] are [[now]]." would highlight "we" and
   * "now".
   *
   * @param textView
   *     <p>CAUTION: This does not work together with textAllCaps attribute!
  ...
  public static void highlightText(TextView textView, @StringRes int typefaceRes) {
    ...
    textView.setText(
        getTypefaceHighlightText(textView.getContext(), string, typefaceRes, null, 0, 0));
  }

  private static CharSequence getTypefaceHighlightText(
      Context context,
      String string,
      @StringRes int typefaceRes,
      Integer highlightColor,
      int colorHighlightStart,
    ...
    while (string.substring(highlightEnd, string.length()).contains("[[")) {
      ...
      if (highlightColor != null
          && colorHighlightStart <= highlightStart
          && colorHighlightEnd >= highlightEnd) {
    ...
    for (Pair<Integer, Integer> spanPosition : spanPositions) {
      highlightSpannable.setSpan(
          new CustomTypefaceSpan("", context.getResources().getString(typefaceRes)),
          spanPosition.first,
          spanPosition.second,
          Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    }
  ...
  public static void linkifyText(
      TextView textView, final int highlightColor, boolean bold, final Runnable onClick) {
   ...
   * Tapping the highlighted region will run the specified Runnable. For example, in "Click _HERE_
   * please." "HERE" will be made the color specified and bolded.
   *
   * <p>CAUTION: This does not work together with textAllCaps attribute!
   *
   * @param textView
  ...
  public static void linkifyText(
    ...
    linkifyText(
        textView, highlightColor, bold ? R.string.wire__typeface__medium : -1, underline, onClick);
  }
  ...
  public static void linkifyText(
    ...
    if (boldTypeface > 0) {
      str.setSpan(
          new CustomTypefaceSpan("", textView.getResources().getString(boldTypeface)),
          highlightStart,
          highlightEnd,
          Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    }

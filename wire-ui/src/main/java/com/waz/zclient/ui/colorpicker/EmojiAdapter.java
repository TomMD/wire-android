...
public class EmojiAdapter extends RecyclerView.Adapter<EmojiAdapter.ViewHolder> {
  ...
  public EmojiAdapter(Context context) {
    ...
    smallSize =
        context
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__item_size__small);
    mediumSize =
        context
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__item_size__medium);
    largeSize =
        context
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__item_size__large);
    categorySpacing =
        context
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__category_spacing);
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(String string) {
      ...
      textView.setTextSize(
          ...
          itemView.getResources().getDimension(emojiSize.getIconSizeResId()));
      int size;

...
public class ZetaButton extends TypefaceTextView {
  ...
  public void setEnabled(boolean isEnabled) {
    ...
    if (isEnabled) {
      ...
      float disabledAlpha =
          ResourceUtils.getResourceFloat(getResources(), R.dimen.button__disabled_state__alpha);
  ...
  public void setAccentColor(int color, boolean keepTextColor) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      ...
      fillColor = isFilled ? accentColor : getResources().getColor(R.color.transparent);
    } else {
      fillColor =
          isFilled
              ? accentColor
    ...
    ViewUtils.setBackground(
        this, getButtonBackground(accentColor, fillColor, strokeWidth, cornerRadius));
  ...
  private void init() {
    ...
    int[] textColors = {
      pressedTextColor, pressedTextColor, getCurrentTextColor(), pressedTextColor
    };
  ...
  private int getPressedColor(int originalColor) {
    float pressedAlpha =
        ResourceUtils.getResourceFloat(getResources(), R.dimen.button__pressed_state__alpha);

...
/**
 * This view will automatically linkify the text passed to {@link LinkTextView#setTextLink(String)},
 * but will not steal touch events that are not inside a URLSpan
 */

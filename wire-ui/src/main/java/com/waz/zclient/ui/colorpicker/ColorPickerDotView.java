...
public class ColorPickerDotView extends View implements ColorPickerView {
  ...
  final int smallDotRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_small_dot_radius);
  final int mediumDotRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_medium_dot_radius);
  final int largeDotRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_large_dot_radius);

  final int smallRingRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_small_ring_radius);
  final int mediumRingRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_medium_ring_radius);
  final int largeRingRadius =
      getResources().getDimensionPixelSize(R.dimen.color_picker_large_ring_radius);

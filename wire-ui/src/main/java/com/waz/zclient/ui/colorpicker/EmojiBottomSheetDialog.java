...
public class EmojiBottomSheetDialog extends BottomSheetDialog {
  ...
  private void init(List<String> recent, Set<String> unsupported) {
    ...
    final GridLayoutManager layoutManager =
        new GridLayoutManager(
            getContext(), getEmojiLayoutManagerSpanCount(), LinearLayoutManager.HORIZONTAL, false);
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      ...
      ll.setBackgroundColor(
          getContext()
              .getResources()
              .getColor(R.color.background_graphite, getContext().getTheme()));
    }
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      //noinspection deprecation
      til.setTextColor(
          getContext().getResources().getColorStateList(R.color.wire__text_color_dark_selector));
      //noinspection deprecation
      ...
      til.setTextColor(
          getContext()
              .getResources()
              .getColorStateList(R.color.wire__text_color_dark_selector, getContext().getTheme()));
      til.setPrimaryColor(
          getContext()
              .getResources()
              .getColor(R.color.text__primary_dark, getContext().getTheme()));
    }
    til.setLabelHeight(
        getContext()
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__tab_label_size));
    til.setCallback(
        new TabIndicatorLayout.Callback() {
          @Override
    ...
    ViewGroup.LayoutParams params =
        new ViewGroup.LayoutParams(
            ...
            getContext()
                .getResources()
                .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__tab_size));
    ...
    adapter.setOnEmojiClickListener(
        new EmojiAdapter.OnEmojiClickListener() {
          @Override
  ...
  private void setRecyclerViewPadding(RecyclerView recyclerView) {
    ...
    switch (currentEmojiSize) {
      case SMALL:
        padding =
            getContext()
                .getResources()
                .getDimensionPixelOffset(R.dimen.sketch__emoji__keyboard__item_padding__small);
        break;
      case MEDIUM:
        padding =
            getContext()
                .getResources()
                .getDimensionPixelOffset(R.dimen.sketch__emoji__keyboard__item_padding__medium);
        break;
      case LARGE:
        padding =
            getContext()
                .getResources()
                .getDimensionPixelOffset(R.dimen.sketch__emoji__keyboard__item_padding__large);
        break;
      default:
        padding =
            getContext()
    ...
    int sidePadding =
        getContext()
            .getResources()
            .getDimensionPixelSize(R.dimen.sketch__emoji__keyboard__side_padding);

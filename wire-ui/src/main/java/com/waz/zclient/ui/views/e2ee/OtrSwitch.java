  ...
  public OtrSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (theme.equals(getResources().getString(R.string.wire_theme_dark))) {
      switchCompat.setThumbDrawable(
          getResources().getDrawable(R.drawable.selector_otr_switch__thumb_dark));
      switchCompat.setTrackDrawable(
          getResources().getDrawable(R.drawable.selector_otr_switch__track_dark));
      if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
        //noinspection deprecation
        textView.setTextColor(
            getResources().getColorStateList(R.color.selector_otr_switch__text_dark));
      } else {
        textView.setTextColor(
            getResources()
                .getColorStateList(
                    R.color.selector_otr_switch__text_dark, getContext().getTheme()));
      }
    }

    if (theme.equals(getResources().getString(R.string.wire_theme_light))) {
      switchCompat.setThumbDrawable(
          getResources().getDrawable(R.drawable.selector_otr_switch__thumb_light));
      switchCompat.setTrackDrawable(
          getResources().getDrawable(R.drawable.selector_otr_switch__track_light));
      if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
        //noinspection deprecation
        textView.setTextColor(
            getResources().getColorStateList(R.color.selector_otr_switch__text_light));
      } else {
        textView.setTextColor(
            getResources()
                .getColorStateList(
                    R.color.selector_otr_switch__text_light, getContext().getTheme()));
      }
    }

...
public enum EmojiSize {
  SMALL(
      R.dimen.sketch__emoji__icon_size__small,
      R.dimen.sketch__emoji__size__small,
      R.dimen.sketch__color_picker_emoji__icon_size__small),
  MEDIUM(
      R.dimen.sketch__emoji__icon_size__medium,
      R.dimen.sketch__emoji__size__medium,
      R.dimen.sketch__color_picker_emoji__icon_size__medium),
  LARGE(
      R.dimen.sketch__emoji__icon_size__large,
      R.dimen.sketch__emoji__size__large,
      R.dimen.sketch__color_picker_emoji__icon_size__large),
  NONE(
      R.dimen.sketch__color_picker_emoji__icon_size__unselected,
      0,
      R.dimen.sketch__color_picker_emoji__icon_size__unselected);

...
public class TabIndicatorLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
  ...
  public void setLabelHeight(int height) {
    ...
    ViewUtils.setPaddingBottom(
        textViewContainer, getResources().getDimensionPixelSize(R.dimen.wire__divider__height));
  ...
  public void setLabels(List<String> lables) {
    ...
    for (int i = 0; i < lables.size(); i++) {
      ...
      TextView textView =
          (TextView) inflater.inflate(R.layout.tab_textview, textViewContainer, false);
  ...
  public void setGlyphLabels(List<String> lables) {
    ...
    for (int i = 0; i < lables.size(); i++) {
      String label = lables.get(i);
      LayoutInflater inflater = LayoutInflater.from(getContext());
      GlyphTextView textView =
          (GlyphTextView) inflater.inflate(R.layout.tab_glyphtextview, textViewContainer, false);
      textViewContainer.addView(textView);
  ...
  public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
    ...
    // positionOffset * anchorWidth is the offset caused by the pager slide between the anchor
    // positions

...
public class BaseClassDetector extends Detector implements Detector.JavaScanner {
  ...
  public static final Issue ISSUE_ACTIVITY =
      Issue.create(
  ...
  public static final Issue ISSUE_FRAGMENT =
      Issue.create(
  ...
  public static final Issue ISSUE_DIALOG_FRAGMENT =
      Issue.create(
  ...
  public static final Issue ISSUE_PREFERENCE_FRAGMENT =
      Issue.create(
  ...
  private void report(
      Issue issue, JavaContext context, JavaParser.ResolvedClass resolvedClass, Node node) {
  ...
  private boolean isGeneratedBaseClass(JavaParser.ResolvedClass resolvedClass) {
    return resolvedClass != null
        && resolvedClass.getSimpleName().startsWith("BaseFragment<.Container>");
  }

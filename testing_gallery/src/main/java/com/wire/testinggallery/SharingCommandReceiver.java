...
public class SharingCommandReceiver extends BroadcastReceiver {
  ...
  // am broadcast -a com.wire.testinggallery.sharing --es package <package name> --es filename
  // "<name of the file in /sdcard/wire>"
  @Override
  ...
  private void shareMultipleFilesToPackage(
      Context context, String requestedPackage, List<File> files) {
